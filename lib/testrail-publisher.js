...
const publishResultsToTestRail = (
    ...
    new Promise((resolve, reject) => {
      testrail
        ...
        .then(suites => {
          ...
          return testrail.addSuite(projectId, { name: suiteName }).body;
        })
    ...
    new Promise((resolve, reject) => {
      testrail
        ...
        .then(cases => {
          ...
          return testrail.addCase(sectionId, { title: mochaTestTitle }).body;
        })
  ...
  getSuiteId(testResults.suite.name)
    ...
    .then(run => {
      ...
      return testrail.addResultsForCases(run.body.id, results);
    })
